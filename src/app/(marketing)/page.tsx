          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                title: '10 Metrics Every Recruiting Team Should Track',
                excerpt: 'From time-to-fill to offer acceptance rate — learn which KPIs actually matter and how to use them to continuously improve your pipeline.',
                readTime: '7 min read',
              ...
              },
              {
                ...
                title: 'Kanban vs List View: Which Pipeline Works for You?',
                excerpt: 'Visual pipelines help some teams, while others prefer list-based workflows. We break down both approaches with real-world examples.',
                readTime: '4 min read',
